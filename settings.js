...
global.owner = [process.env.OWNER_NUMBER] || ['94719102008'] // Owner number , (අයිතිකරුගේ නම්බර් එක )

module.exports = {    
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD:SlippingShawl',
...
OWNER_NUMBER: process.env.OWNER_NUMBER || '94719102008'  ,    
ALIVE: process.env.ALIVE || `default`,
OWNER_NAME: process.env.OWNER_NAME || 'Chenula Dulnith' ,     
